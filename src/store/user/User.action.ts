...
export type GoogleSignInStart = ActionWithPayload<USER_ACTION_TYPES.GOOGLE_SIGN_IN_START, { showToast: Function }>
...
export type UpdateUserInfoStart = ActionWithPayload<USER_ACTION_TYPES.UPDATE_USER_INFO_START, { displayName: string, email: string, imageFile: string, selectedIamge: string, showToast: Function }>
...
export type UpdateUserPasswordStart = ActionWithPayload<USER_ACTION_TYPES.UPDATE_USER_PASSWORD_START, { oldPassword: string, newPassword: string, showToast: Function }>
...
export const googleSignInStart = withMatcher((showToast: Function): GoogleSignInStart => createAction(USER_ACTION_TYPES.GOOGLE_SIGN_IN_START, { showToast }))
...
export const updateUserInfoStart = withMatcher((displayName: string, email: string, imageFile: string, selectedIamge: string, showToast: Function): UpdateUserInfoStart => createAction(USER_ACTION_TYPES.UPDATE_USER_INFO_START, { displayName, email, imageFile, selectedIamge, showToast }))
...
export const updateUserPasswordStart = withMatcher((oldPassword: string, newPassword: string, showToast: Function): UpdateUserPasswordStart => createAction(USER_ACTION_TYPES.UPDATE_USER_PASSWORD_START, { oldPassword, newPassword, showToast }))
